...
use PainelDLX\Domain\CadastroUsuarios\Exceptions\SenhaAtualNaoConfereException;
use PainelDLX\Domain\CadastroUsuarios\Exceptions\SenhasInformadasNaoConferemException;
